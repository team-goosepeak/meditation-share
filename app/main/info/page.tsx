  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link href="/auth/signup" className="bg-white text-primary-700 hover:bg-gray-100 px-8 py-3 text-lg rounded-lg font-medium transition-colors border-2 border-white">
                시작하기
              </Link>
              <Link href="/auth/login" className="bg-transparent border-2 border-white text-white hover:bg-white/10 px-8 py-3 text-lg rounded-lg font-medium transition-colors">
                로그인
              </Link>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; 2025 리플렉션 - Worship Reflection. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
